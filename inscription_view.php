...
if (!isset($_COOKIE['id']) || !isset($_SESSION['id'])) {
    ...
    if (isset($_GET["error"])) {
        ...
        if ($error == 1) {
            ...
            displayError("Le mot de passe doit contenir au moins 8 caractères, une majuscule et un caractère spécial.");
        }
    }
...
?>
    ...
    <head>
        ...
        <title>Cinérama: inscription</title>
        ...
        <div class="center">
            ...
            <div class="row justify-content-center">
                <div class="inscriptionDiv">
                    ...
                    <form action="../cinerama/fonctions/inscription.php" method="POST" class="mb-2" id="inscriptionForm">
                    ...
                    <span class="text-white">Déjà inscrit ? <a href="./connexion">Se connecter</a></span>
                </div>
            </div>
        </div>
