...
export function createActors(id, type, title, modalContent, backgroundModal, linkYtbBtn, videoFrame, modalTitle, seasonsSelect, episodesSelect, validateBtn, synopsisModal, background, modal) {
    ...
    actorsLink.addEventListener("click", function () {
        createActorsModal(id, type, title, backgroundModal, linkYtbBtn, videoFrame, modalTitle, seasonsSelect, episodesSelect, validateBtn, synopsisModal, background, modal, modalContent);
        document.body.style.cursor = "wait";
    });

}

async function createActorsModal(id, type, title, backgroundModal, linkYtbBtn, videoFrame, modalTitle, seasonsSelect, episodesSelect, validateBtn, synopsisModal, background, modal, modalContent) {
        ...
        for (let actor of actors.characters) {
            ...
            if (actorAvatar != null) {
                ...
                actorImg.addEventListener("click", function () {
                    if (type == "movies") {
                        createActorModal(actorInfos, backgroundModal, linkYtbBtn, videoFrame, modalTitle, seasonsSelect, episodesSelect, validateBtn, synopsisModal, background, modal, modalContent);
                    } else {
                        fetch(`https://api.betaseries.com/persons/person?id=${actor.person_id}&key=${api_key}`)
                            .then(response => response.json())
                            .then(actorInfo => createActorModal(actorInfo, backgroundModal, linkYtbBtn, videoFrame, modalTitle, seasonsSelect, episodesSelect, validateBtn, synopsisModal, background, modal, modalContent))
...
function createActorModal(actor, backgroundModal, linkYtbBtn, videoFrame, modalTitle, seasonsSelect, episodesSelect, validateBtn, synopsisModal, background, modal, modalContent) {
    console.log(actor)
            ...
            if (actor.person.movies[i].movie.poster != null && actor.person.movies[i].movie.poster != "null" && actor.person.movies[i].movie.poster != "") {
                ...
                moviePoster.addEventListener("click", function () {
                    ...
                    function filmInformations(filmInfo) {
                        ...
                        createAdminEditButton(id, filmInfo);
