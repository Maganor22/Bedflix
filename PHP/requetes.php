...
if (isset($_GET['requete'])) {
    ...
    switch ($requete) {
        ...
        case 'insertSerie':
            $dataInsertSerie = insertSerie($_POST['titre'], $_POST['annee'], $_POST['poster'], $_POST['affiche'], $_POST['id_du_media'], $_POST['imdb'], $_POST['ba'], $_POST['synopsis'], $_POST['genre'], $_POST['nombre_episodes_par_saison'], $db);
