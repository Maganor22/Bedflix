...
if (!isset($_COOKIE['id']) || !isset($_SESSION['id'])) {
    ...
    if (isset($_GET["failed"])) {
        ...
        switch ($failed) {
            case 1:
                displayAlert("alert-danger", "Indentifiants incorrect.");
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                displayAlert("alert-danger", "Votre clé a expiré. Veuillez vous réinscrire.");
                break;
    ...
    if (isset($_GET["success"])) {
        ...
        switch ($success) {
            case "email_verif":
                ...
                break;
            case "mdp_change":
                displayAlert("alert-success", "Votre mot de passe a été modifié avec succès !");
                break;
            default:
                break;
        }
            ...
            <div class="row justify-content-center logs">
                <div class="connexionDiv">
                    ...
                    <div class="logoConnexion d-flex justify-content-center">
                        ...
                        <h1 class="cinerama cineramaConnexion">CINÉRAMA</h1>
                    </div>
                    <h2 class="text-white">Connexion</h2>
                    <form action="../cinerama/fonctions/connexion.php" method="POST" class="d-flex flex-column flex-md-row" id="connexionForm">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="identifier" class="text-white fw-bold">Indentifiant :</label>
                                <input type="text" name="identifier" placeholder="Email/Pseudonyme" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="button-group mt-4 mb-2">
                                <button class="btn btn-warning w-100" type="submit">Connexion</button>
                            </div>
                            <div>
                                <input type="checkbox" name="remember" id="remember" class="form-check-input">
                                <label for="remeber" name="remember" class="form-check-label text-white">Rester connecter</label>
                            </div>
                            <div class="mb-3">
                                <a href="./forgot_password" class="text-white">Mot de passe oublié ?</a>
                            </div>
                            <span class="text-white">Pas de compte ? <a href="./inscription">S'inscrire ici</a></span>
                        </div>
                    </form>
                </div>
            </div>
