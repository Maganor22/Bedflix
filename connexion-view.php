                ...
                <div class="connexionDiv">
                    ...
                    <form action="../Bedflix/fonctions/connexion.php" method="POST" class="d-flex flex-column flex-md-row" id="connexionForm">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                <a href="./forgot_password_view.php" class="text-white">Mot de passe oublié ?</a>
                            </div>
                            <span class="text-white">Pas de compte ? <a href="./inscription-view.php">S'inscrire ici</a></span>
                        </div>
                    </form>
                </div>
            </div>
